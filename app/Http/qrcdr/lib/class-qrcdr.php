...
namespace App\Http\Qrcdr;

use App\Http\Qrcdr\QRcode;
use App\Http\Qrcdr\EasySvg;
...
class QRvct extends QRvect
{
    ...
    {
        include_once dirname(__FILE__) . '/EasySVG.php';
        ...
        if ($setframe) {
            ...
            $frame_label = isset($style['frame_label']) ? $style['frame_label'] : '';
            ...
            $frame_labelpos = $frames[$frametype]['label_pos'];
            ...
            $frametranslate = $frame_labelpos == 'top' ? ' transform="translate(0,' . $framediff . ')"' : '';
            $offtop = $frame_labelpos == 'top' ? $framediff : 0;
        ...
        $output .= '<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" xmlns:xlink="http://www.w3.org/1999/xlink" class="qrcodesvg" width="' . $realimgW . '" height="' . $realimgH . '" viewBox="0 0 ' . $realimgW . ' ' . $realimgH . '">' . "\n";
        ...
        */
        ...
        // $bg_image = '/webflow/images/Wow-gif.gif';
        // $bg_image = '/webflow/images/love.gif';
        // dd($bg_image);
        $offtop = 48;
        $offbutton= 42;
        // dd($watermark);
        ...
        if ($bg_image) {
            $base64 = false;
            $basemark = 'data:image/';
            if (substr($bg_image, 0, strlen($basemark)) === $basemark) {
                $base64 = $bg_image;
            } else {
                $path = public_path('/images/animated-images/' . basename($bg_image));
            ...
            elseif($setframe == "balloon-bottom"){
                $offbutton = 0;
                $widthBack = 11;
                $heightBack = 102;
            }
            elseif($setframe == "balloon-top"){
                $offbutton = 0;
                $offtop = 240;
                $widthBack = 11;
                $heightBack = 102;
            }
            elseif($setframe == "ribbon-bottom"){
                $widthBack = 86;
                $heightBack = 96;
            }
            elseif($setframe == "ribbon-top"){
                $offtop = 150;
                $widthBack = 86;
                $heightBack = 96;
            }
            elseif($setframe == "phone"){
                $offbutton = 30;
                $offtop = 30;
                $widthBack = 62;
                $heightBack = 60;
            }
            elseif($setframe == "cine"){
                $offbutton = 30;
                $offtop = 20;
                $widthBack = 72;
                $heightBack = 40;
            ...
            if ($base64) {
                $output .= '<image' . $maskurl . ' xlink:href="' . $base64 . '" width="' . ($backgroundsize-$widthBack) . '" height="' . ($backgroundsize-$heightBack) . '" x="' . ($backgroundmargin+$offbutton) . '" y="' . ($backgroundmargin + $offtop) . '" />' . "\n";
            }
        }
        ...
        if ($setframe && $frame_label && $label_font) {
            ...
            if ($textWidth > 0 && $textHeight > 0) {
                ...
                $textpathy = $frame_labelpos == 'bottom' ? $realimgW + $offset - ($textHeight / 3 * $textscale) : 0;
                $textpathy = $frame_labelpos == 'top' && $textscale < 0.5 ? $textscale * $frameunit : $textpathy;
        ...
        if ($watermark) {
            ...
            if (substr($watermark, 0, strlen($basemark)) === $basemark) {
                ...
                $path = public_path('/images/watermarks/' . basename($watermark));
                // dd($path);
                if (file_exists($path)) {
                    $mimetype = mime_content_type($path);
                    $type = $mimetype == 'image/svg' ? $mimetype . '+xml' : $mimetype;
            ...
            if ($base64) {
                ...
                $watermark_pos_y = $setframe && $frame_labelpos == 'top' ? $watermark_pos + $framediff : $watermark_pos;
