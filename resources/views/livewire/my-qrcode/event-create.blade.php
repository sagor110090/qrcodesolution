...
<div class="p-6 mx-auto mt-20 bg-white rounded-lg shadow max-w-7xl sm:px-6 lg:px-8 dark:bg-gray-800">

    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 md:col-span-4">
            <ol
                class="relative text-gray-500 border-l border-r border-gray-200 dark:border-gray-700 dark:text-gray-400 ">
        ...
        <div class="col-span-12 md:col-span-8">
            <div class="grid grid-cols-12 gap-4 {{ $currentStep == 'step1' ? 'block' : 'hidden' }}">
                ...
                <div class="col-span-12">
                    <x-input placeholder="Event name" id="name" wire:model="event.name" class="col-span-6 mt-3" />
                    <<x-input placeholder="Event URL" id="event_url" wire:model="event_url" suffix=".qrcodesolution.com"
                        class="col-span-6 mt-3" />
                    <x-textarea placeholder="Description" id="description" wire:model="event.description" rows="3"
                        class="col-span-6 mt-3 resize-none" />
                </div>
            ...
            <div class="grid grid-cols-12 gap-4 {{ $currentStep == 'step2' ? 'block' : 'hidden' }}">
                ...
                <div class="col-span-12">
                    <x-input placeholder="Location" id="location" wire:model="event.location" class="col-span-6" />
                    <div class="col-span-6 mt-2">
                        <x-toggle lg wire:model.live="event.one_day_event" label="One day event" />
                    </div>
                    <div class="grid grid-cols-12 gap-4 mt-2 {{ $event['one_day_event'] ? 'hidden' : 'block' }}">
                        <div class="col-span-6">
                            <x-datetime-picker placeholder="Start date and time"
                                wire:model.defer="event.start_date_time" />
                        </div>
                        <div class="col-span-6">
                            <x-datetime-picker placeholder="End date and time" wire:model.defer="event.end_date_time" />
                        </div>

                    </div>
                    <div class="grid grid-cols-12 gap-4 mt-2 {{ $event['one_day_event'] ? 'block' : 'hidden' }}">
                        <div class="col-span-6">
            ...
            <div class="grid grid-cols-12 gap-4 {{ $currentStep == 'step3' ? 'block' : 'hidden' }}">
                ...
                <div class="col-span-12">
                    ...
                    <x-select placeholder="Select the font" :options="Support::eventFonts()" option-label="name" option-value="name"
                        wire:model.defer="event.font" class="mt-3" />
