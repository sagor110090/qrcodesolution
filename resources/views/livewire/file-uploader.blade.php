<div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
    ...
    <div class="flex flex-col items-center justify-center h-24" x-show.transition="!isUploading">
        <label for="{{$name}}" class="relative block leading-tight bg-white hover:bg-gray-100 cursor-pointer  items-center transition duration-500 ease-in-out group overflow-hidden
            border-2 w-full pl-3 pr-4 py-2 rounded-lg border-dashed" wire:loading.class="pointer-events-none">

            <input type="file" id="{{$name}}" class="absolute inset-0 cursor-pointer opacity-0 text-transparent sr-only"
                accept="{{ $accept }}" wire:model.live="file" />
            <div
                class="flex items-center justify-center flex-1 px-4 py-2   text-sm leading-normal font-medium group-hover:text-indigo-500 text-indigo-500">
                @if ($name == 'image')

                <svg class="h-8 w-8  group-hover:text-indigo-500 text-indigo-500" xmlns="http://www.w3.org/2000/svg"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    class="h-8 w-8  group-hover:text-indigo-500 text-indigo-500" fill="currentColor"
                ...
                @elseif ($name == 'video')
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8  group-hover:text-indigo-500 text-indigo-500 mr-2" width="16" height="16" fill="currentColor" class="bi bi-film" viewBox="0 0 16 16">
    ...
    <div class="flex flex-col items-center justify-center h-24">
        <div
            class="flex items-center justify-center flex-1 px-4 py-2   text-sm leading-normal font-medium text-indigo-500">
            @if ($name == 'image')
