...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
        ...
        <x-nav-link href="{{ route('plans.index') }}" :active="request()->is('*plans*')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-credit-card-2-front h-6 w-6" viewBox="0 0 16 16">
                    <path d="M0 3a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2H0V3Zm0 3v6a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V6H0Zm1 1h14v2H1V7Z"/>
                    <path d="M0 11a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2H0v-2Z"/>
                  </svg>
            </x-slot>
            {{ __('Plan') }}
        </x-nav-link>
        ...
        <x-nav-link href="{{ route('users.index') }}" :active="request()->is('*users*')">
            <x-slot name="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people h-6 w-6" viewBox="0 0 16 16">
