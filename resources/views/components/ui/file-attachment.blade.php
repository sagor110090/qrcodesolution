                    ...
                    <div class="py-3 flex {{ !$loop->last ? 'border-b border-gray-200' : '' }}">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-1">
                                <div class="text-xs text-gray-500">{{ App\Helpers\Support::bytesToHuman($f->getSize()) }}</div>
                ...
                @if($file)
                    <div class="mt-3 flex">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-1">
                                <div class="text-xs text-gray-500">{{ App\Helpers\Support::bytesToHuman($file->getSize()) }}</div>
                                <div class="text-gray-400 text-xs">&bull;</div>
