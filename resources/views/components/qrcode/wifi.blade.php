...
<div class="px-6 py-4 border-neutral-100 dark:border-neutral-500" x-show="type === 'wifi'" x-data x-cloak>
    ...
    <div class="mt-2 text-sm text-neutral-500 dark:text-neutral-300 text-weight-300">
        ...
        <x-tw.checkbox label="Hidden" id="hidden" value="true" class="w-10 col-span-2" name="wifi_hidden"  value="{{ $wifi_hidden }}"/>
