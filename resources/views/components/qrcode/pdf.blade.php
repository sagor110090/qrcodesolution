...
<div class="border-neutral-100 px-6 py-4 dark:border-neutral-500" x-show="type === 'pdf'">
    ...
    <div class="mt-2 text-sm  text-neutral-500 dark:text-neutral-300 text-weight-300">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="col-span-2 text-center text-neutral-500 dark:text-neutral-300 text-weight-300">
                ...
                <livewire:file-uploader :name="'pdf'" :accept="'application/pdf'" :text="'Upload PDF'"
                    :rules="[ 'file', 'max:10024','mimes:pdf' ]" :loadFileName="$pdf" />
                @error('pdf') <span class="text-red-500 mt-1 text-sm">{{ $message }}</span> @enderror
