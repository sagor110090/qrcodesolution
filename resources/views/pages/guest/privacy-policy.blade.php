    ...
    <div class="flex items-center justify-center w-full pt-24">
        <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
            <div class="container p-8 mx-auto">
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">Introduction</h2>
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">Information We Collect</h2>
                <h3 class="mt-4 text-lg font-semibold">1. Personal Information</h3>
                ...
                <ul class="pl-8 list-disc dark:text-white">
                    <li>Name</li>
                    <li>Email address</li>
                ...
                <h3 class="mt-4 text-lg font-semibold">2. Non-Personal Information</h3>
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">How We Use Your Information</h2>
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">Disclosure of Your Information</h2>
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">Your Choices</h2>
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">Security</h2>
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">Changes to this Privacy Policy</h2>
                ...
                <h2 class="mt-8 text-xl font-semibold dark:text-white">Contact Us</h2>
