    ...
    <div class="flex items-center justify-center w-full pt-24">
        <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
            <div class="container p-8 mx-auto">
                <h1
                    class="grid justify-center mt-5 text-4xl font-bold tracking-tight text-slate-900 dark:text-slate-100 sm:text-6xl">
                    Terms of Service
                </h1>
                <p class="mt-8 dark:text-white">These Terms and Conditions (&quot;Terms&quot;) govern your use of the
                ...
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">1. Acceptance
                        of
                        Terms</strong></p>
                <p class="mt-8 dark:text-white">By using the Website, you agree to be bound by these Terms, including
                    any
                ...
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">2. Use of the
                        Website</strong></p>
                <p class="mt-8 dark:text-white">You agree to use the Website in accordance with all applicable local,
                    state,
                    national, and international
                    laws and regulations. You will not use the Website for any unlawful or prohibited purpose.</p>
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">3.
                        Intellectual
                        Property</strong></p>
                <p class="mt-8 dark:text-white">All content on the Website, including but not limited to text, graphics,
                    ...
                    written
                    consent.</p>
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">4.
                        User-Generated
                        Content</strong></p>
                <p class="mt-8 dark:text-white">If the Website allows users to submit content, you agree not to post,
                    upload,
                ...
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">5. Privacy
                        Policy</strong></p>
                <p class="mt-8 dark:text-white">Your use of the Website is also governed by our Privacy Policy, which is
                    incorporated by reference into
                    these Terms. Please review our Privacy Policy to understand how we collect, use, and protect your
                    personal information.</p>
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">6. Links to
                        Third-Party Websites</strong></p>
                <p class="mt-8 dark:text-white">The Website may contain links to third-party websites or services that
                    are
                ...
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">7.
                        Disclaimers</strong></p>
                <p class="mt-8 dark:text-white">The Website is provided on an &quot;as is&quot; and &quot;as
                    available&quot;
                    basis. Qrcodesolution.com
                    makes no warranties or representations regarding the accuracy, reliability, or availability of the
                    Website.</p>
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">8. Limitation
                        of
                        Liability</strong></p>
                <p class="mt-8 dark:text-white">In no event shall qrcodesolution.com be liable for any direct, indirect,
                    special, consequential, or
                    incidental damages arising out of or in connection with the use of the Website.</p>
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">9.
                        Indemnification</strong></p>
                <p class="mt-8 dark:text-white">You agree to indemnify and hold qrcodesolution.com, its affiliates, and
                    its
                ...
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">10.
                        Termination</strong></p>
                <p class="mt-8 dark:text-white">Qrcodesolution.com reserves the right to terminate or suspend your
                    access to
                    the Website at any time,
                    with or without cause and with or without notice.</p>
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">11. Governing
                        Law</strong></p>
                <p class="mt-8 dark:text-white">These Terms are governed by and construed in accordance with the laws of
                    [Your Jurisdiction], without
                    regard to its conflict of law principles.</p>
                <p class="mt-8 dark:text-white"><strong class="mt-8 text-xl font-semibold dark:text-white">12. Contact
                        Information</strong></p>
                <p class="mt-8 dark:text-white">If you have any questions about these Terms, please contact us at
