            ...
            <div class="col-span-12 md:col-span-8">
                <div class="grid grid-cols-12 gap-4 {{$currentStep == 'step1' ? 'block' : 'hidden'}}">
                    <div class="col-span-12">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Event name, description, and time zone.</p>
                    </div>
                    <div class="col-span-12">
                        ...
                        <x-textarea placeholder="Description" id="description" wire:model="event.description" rows="3"
                            class="resize-none col-span-6 mt-3" />
                    </div>
                ...
                <div class="grid grid-cols-12 gap-4 {{$currentStep == 'step2' ? 'block' : 'hidden'}}">
                    <div class="col-span-12">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Event location and online event setup.</p>
                    </div>
                    <div class="col-span-12">
                        ...
                        <div class="grid grid-cols-12 gap-4 mt-2 {{ $event['one_day_event'] ? 'block' : 'hidden' }}">
                            ...
                            <div class="col-span-6">
                                <x-input placeholder="Duration" id="duration" wire:model="event.duration" class="col-span-6" />
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-12 gap-4 {{$currentStep == 'step3' ? 'block' : 'hidden'}}">
                    ...
                    <div class="col-span-12">
                        ...
                        <x-select placeholder="Select the font" :options="Support::eventFonts()" option-label="name" option-value="name" wire:model.defer="event.font" class="mt-3" />
